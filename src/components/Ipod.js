                ...
                <div id='inner-container' style={styles.wheel} onMouseOver={this.rotateWheel}>
                    ...
                    <div style={styles.buttonContainer}>
                        <div style={styles.middleButtons}>
                            ...
                            <div onClick={this.changePage} className='center-button' style={{ backgroundImage: 'linear-gradient(45deg, #023ED4, transparent)', width: '5rem', height: '5rem', borderRadius: '50%' }}><b>Select</b></div>
...
const styles = {
    ipodContainer: {
        ...
        backgroundImage: 'radial-gradient(#0048EA , #13004D)',
        margin: '4rem auto',
        display: 'flex',
        flexDirection: 'row',
        flexWrap: 'wrap',
