...
// import sound from './music/shiv.mp3'
        ...
        return(
            <div style={styles.myMusicContainer}>
                ...
                <div style={styles.info}>
                    <img style={styles.image} src="https://www.rudraksha-ratna.com/uploads/files/8291623464.jpg" alt=''></img>
                    <div style={styles.subInfo}>
                        <h4 style={{marginBottom:'0.5rem'}}>Shiv</h4>
                        <p style={{marginBottom:'0'}}>Shankar Mahadevan</p>
