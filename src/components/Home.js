            ...
            <div style={styles.homeScreen} id='home-screen'>
                <div style={styles.menuList} id='menu-list'>
                    <div style={styles.titleBar}>
                        ...
                        <img style={styles.battery} src="https://cdn-icons-png.flaticon.com/128/25/25694.png" alt=''></img>
                    </div>
                    <ListGroup style={{borderRadius:'0'}}>
                        ...
                        <ListGroup.Item style={{border:'0',padding: '0.2rem 0.6rem'}} className={this.props.activeItem==='CoverFlow'?'active':''}>
                            <b>Cover Flow</b> {this.props.activeItem==='CoverFlow'?<span style={{float:'right' ,fontWeight:'bold'}}>&gt;</span>:''}
                        </ListGroup.Item>
...
const styles = {
    ...
    imageContainer : {
        ...
        height : '100%',
        width : '50%',
        backgroundImage : 'url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPyXZwdwbIEabqEM0ZVvvIlRVlI0RjyH3pcQ&usqp=CAU")',
